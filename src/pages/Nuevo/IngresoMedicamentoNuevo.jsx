      ...
      <Grid container spacing={2} >
              ...
              <Box style={{ width: '95%', margin: 'auto' }} >
                ...
                <Grid container spacing={2} sx={{ paddingRight: 2 }}>
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={4} xxl={4}>
                    <InputComponent label="N° Factura" name="N_FACTURA" value={data?.N_FACTURA} onChange={handleInputChanges}/>
                  </Grid>  
        ...
        <Grid item xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
          <Paper sx={{ paddingTop: 2, paddingBottom: 2, paddingLeft: 2, display: 'flex', flexDirection: 'column' }} style={{ width: '95%', margin: 'auto', marginTop: '20px' }} >
            <React.Fragment>
              <Box style={{ width: '95%', margin: 'auto' }} >
                <Typography style={{ marginBottom: '15px' }} component="h2" variant="h6" color="primary" gutterBottom className={"title-header"}>Datos del Proveedor</Typography>   
                <Grid container spacing={2} sx={{ paddingRight: 2 }}>
                  <Grid item xs={12} sm={6} md={4} lg={4} xl={3} xxl={3}>
                    <InputComponent label="Proveedor" name="PROVEEDOR" value={data?.PROVEEDOR} onChange={handleInputChanges}/>
                  </Grid>  
                  <Grid item xs={12} sm={6} md={4} lg={3} xl={3} xxl={3}>
                    <InputComponent label="Ruc" name="RUC" value={data?.RUC} onChange={handleInputChanges}/>
                  </Grid>  
                </Grid>
              </Box>
            </React.Fragment>
...
export default IngresoMedicamentoNuevo